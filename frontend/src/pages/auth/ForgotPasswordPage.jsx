    ...
    <main className="relative flex min-h-screen items-center overflow-hidden bg-[#f4f7f2] px-5 py-12 sm:px-8">
      ...
      <section className="relative mx-auto grid w-full max-w-5xl overflow-hidden rounded-3xl border border-white/80 bg-white shadow-[0_24px_80px_rgba(20,55,37,0.14)] lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="p-7 sm:p-10">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-emerald-700">Account recovery</p>
          <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">Reset your password</h1>
          <p className="mt-3 max-w-md leading-6 text-slate-500">Enter the email connected to your account and we will send you a secure reset link.</p>
