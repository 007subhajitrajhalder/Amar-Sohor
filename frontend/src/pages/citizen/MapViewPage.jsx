...
function MapViewPage() {
  ...
  const FacilityIcon = getFacilityIcon(selectedCategory);
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex items-center justify-between px-2 py-1">
            ...
            <nav className="hidden items-center gap-8 lg:flex">
              ...
              <Link
                to="/"
                className="text-sm text-white/70 transition duration-300 hover:text-lime-300"
              >
                Home
              </Link>
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/15 bg-white/[0.06] lg:hidden"
            >
          ...
          {mobileMenu && (
            <div className="mt-3 rounded-2xl border border-white/10 bg-[#080d1b]/95 p-4 shadow-2xl backdrop-blur-2xl lg:hidden">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Link
                  ...
                  className="rounded-xl px-4 py-3 text-white/70 transition hover:bg-white/10 hover:text-lime-300"
                >
                  Home
                </Link>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-white/50 md:text-base">
                Locate registered public facilities around your
                current location and find the nearest available
                service point within 10 km.
              </p>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              {filteredFacilities.map((facility) => {
                ...
                const CardIcon = getFacilityIcon(
                  facility.category
                );
          ...
          <div className="grid gap-12 md:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-6 max-w-sm text-sm leading-7 text-white/45">
                ...
                A citizen-centric smart city platform designed
                to help people discover public facilities and
                stay connected with their city.
            ...
            <div>
              ...
              <p className="mt-6 max-w-xs text-sm leading-6 text-white/40">
                ...
                Stay connected with Amar Sohor and follow our
                latest updates across social platforms.
