...
const BorderGlow = ({
  ...
  return (
    <div
      ...
      className={`relative grid isolate border border-white/15 transition-transform duration-300 ease-out ${className}`}
      style={{
        background: backgroundColor,
        borderRadius: `${borderRadius}px`,
        transform: isHovered && liftOnHover ? 'translate3d(0, -6px, 0.01px)' : 'translate3d(0, 0, 0.01px)',
    ...
    >
      ...
      <span
        ...
        style={{
          inset: `${-glowRadius}px`,
          maskImage: `conic-gradient(from ${angleDeg} at center, black ${coneSpread}%, transparent ${coneSpread + 10}%, transparent ${90 - coneSpread}%, black ${100 - coneSpread}%)`,
          WebkitMaskImage: `conic-gradient(from ${angleDeg} at center, black ${coneSpread}%, transparent ${coneSpread + 10}%, transparent ${90 - coneSpread}%, black ${100 - coneSpread}%)`,
          opacity: glowOpacity,
