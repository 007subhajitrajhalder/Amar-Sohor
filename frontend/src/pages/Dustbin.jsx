...
function Dustbin() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-950 text-white">
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-white/50 md:text-base">
                Locate registered public dustbins around your
                current location and find the nearest available
                waste disposal point within 10 km.
              </p>
        ...
        >
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-8">
              ...
              <h2 className="mt-2 text-2xl font-bold md:text-3xl">
                Dustbins near Kolkata
              </h2>

              <p className="mt-2 text-sm text-white/40">
                Explore the selected dustbin locations on the map.
              </p>
            ...
            <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl">
              ...
              <div className="relative h-[420px] w-full">
                ...
                <iframe
                  title="Dustbin locations in Kolkata"
            ...
            <div className="rounded-3xl border border-lime-300/10 bg-lime-300/5 p-8 md:p-12">
              ...
              <div className="max-w-3xl">
                ...
                <h2 className="mt-3 text-3xl font-bold md:text-4xl">
                  Use the nearest dustbin.
                  <br />
                  Keep Amar Sohor cleaner.
                </h2>

                <p className="mt-4 text-sm leading-7 text-white/45">
                  Help maintain a cleaner city by disposing of
                  waste responsibly. If you notice an overflowing
                  or damaged dustbin, you can report the issue
                  through Amar Sohor.
                </p>
      ...
      <footer
        id="contact"
        className="border-t border-white/10 px-5 py-12 md:px-10"
      >
          ...
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-4 max-w-sm text-sm leading-6 text-white/35">
                Making everyday city life easier by connecting
                citizens with essential public facilities.
              </p>
